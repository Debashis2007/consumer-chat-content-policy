...
**Parent system design:** [06 — Multi-Layer Safety / Moderation](https://github.com/Debashis2007/consumer-chat-content-policy/blob/main/06-safety-moderation-pipeline.md)
...
Reuse layered plane and fail-closed rules from **06**; integrate with [02 streaming](https://github.com/Debashis2007/consumer-chat-content-policy/blob/main/02-streaming-token-delivery.md).
...
- Under-refuse after model upgrade → canary safety gates ([05](https://github.com/Debashis2007/consumer-chat-content-policy/blob/main/05-model-monitoring-observability.md)).
